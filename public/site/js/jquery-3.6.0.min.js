!(function (e, t) {
  ...
  function u(e) {
    var t = {};
    return (
      Ee.each(e.match(Pe) || [], function (e, n) {
        t[n] = !0;
      }),
      t
    );
    ...
    for (var n, r, i = [], o = 0, a = e.length; o < a; o++)
      (r = e[o]),
        r.style &&
          ...
          t
            ? ("none" === n &&
                ((i[o] = $e.get(r, "display") || null),
                i[o] || (r.style.display = "")),
              "" === r.style.display && Ke(r) && (i[o] = x(r)))
            : "none" !== n && ((i[o] = "none"), $e.set(r, "display", n)));
  ...
  function H(e, t) {
    ...
    if (1 === t.nodeType) {
      if ($e.hasData(e) && ((o = $e.get(e)), (u = o.events))) {
        ...
        for (i in u)
          for (n = 0, r = u[i].length; n < r; n++) Ee.event.add(t, i, u[i][n]);
      }
      _e.hasData(e) &&
        ((a = _e.access(e)), (s = Ee.extend({}, a)), _e.set(t, s));
    }
  }
  function O(e, t) {
  ...
  function P(e, t, r, i) {
    ...
    var o,
      ...
      h = t[0],
      g = xe(h);
    if (g || (p > 1 && "string" == typeof h && !me.checkClone && lt.test(h)))
    ...
    if (
      ...
      for (s = Ee.map(w(o, "script"), q), u = s.length; f < p; f++)
        (l = o),
          f !== d &&
            ((l = Ee.clone(l, !0, !0)), u && Ee.merge(s, w(l, "script"))),
          r.call(e[f], l, f);
      if (u)
        for (c = s[s.length - 1].ownerDocument, Ee.map(s, L), f = 0; f < u; f++)
          (l = s[f]),
            nt.test(l.type || "") &&
  ...
  function R(e, t, n) {
    for (var r, i = t ? Ee.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || Ee.cleanData(w(r)),
        r.parentNode &&
          (n && Qe(r) && T(w(r, "script")), r.parentNode.removeChild(r));
    return e;
  }
  function M(e, t, n) {
    var r,
  ...
  function F(e) {
    ...
    return t ? t : e in vt ? e : (yt[e] = W(e) || e);
  }
  function B(e, t, n) {
    var r = Ve.exec(t);
  ...
  function $(e, t, n, r, i, o) {
    ...
    for (; a < 4; a += 2)
      "margin" === n && (u += Ee.css(e, n + Ge[a], !0, i)),
        r
          ? ("content" === n && (u -= Ee.css(e, "padding" + Ge[a], !0, i)),
            "margin" !== n &&
              (u -= Ee.css(e, "border" + Ge[a] + "Width", !0, i)))
          : ((u += Ee.css(e, "padding" + Ge[a], !0, i)),
            "padding" !== n
              ? (u += Ee.css(e, "border" + Ge[a] + "Width", !0, i))
              : (s += Ee.css(e, "border" + Ge[a] + "Width", !0, i)));
    return (
      !r &&
        o >= 0 &&
        (u +=
  ...
  function V(e, t) {
    ...
    for (t = t ? 1 : 0; r < 4; r += 2 - t)
      (n = Ge[r]), (i["margin" + n] = i["padding" + n] = e);
          ...
          return r != H && 9 === r.nodeType && r.documentElement
            ? ((H = r),
              ...
              (T.scope = i(function (e) {
                return (
                  O.appendChild(e).appendChild(H.createElement("div")),
                  "undefined" != typeof e.querySelectorAll &&
  ...
  (Ee.filter = function (e, t, n) {
    ...
    Ee.fn.extend({
      ...
      is: function (e) {
        return !!a(
          this,
          "string" == typeof e && Ne.test(e) ? Ee(e) : e || [],
          !1
        ).length;
      },
    });
      ...
      function (e, t) {
        Ee.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (Oe[e] || Ee.uniqueSort(i), He.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
                ...
                return function () {
                      ...
                      : function () {
                          try {
                            ...
                            Ee.Deferred.exceptionHook &&
                              Ee.Deferred.exceptionHook(e, p.stackTrace),
                              t + 1 >= a &&
                                (r !== c && ((s = void 0), (u = [e])),
                                n.rejectWith(s, u));
                          }
                  ...
                  t
                    ...
                    : (Ee.Deferred.getStackHook &&
                        (p.stackTrace = Ee.Deferred.getStackHook()),
                      e.setTimeout(p));
                };
              }
              var a = 0;
    ...
    Ee.extend({
      ...
      ready: function (e) {
        (e === !0 ? --Ee.readyWait : Ee.isReady) ||
          ((Ee.isReady = !0),
          (e !== !0 && --Ee.readyWait > 0) || Me.resolveWith(we, [Ee]));
      },
    }),
    (Ee.ready.then = Me.then),
    ...
    Ee.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = _e.get(o)), 1 === o.nodeType && !$e.get(o, "hasDataAttrs"))
          ) {
            for (n = a.length; n--; )
              a[n] &&
                ((r = a[n].name),
  ...
  Ye.getRootNode &&
    (Qe = function (e) {
      return (
        Ee.contains(e.ownerDocument, e) || e.getRootNode(Je) === e.ownerDocument
      );
    });
  var Ke = function (e, t) {
      return (
        ...
        "none" === e.style.display ||
          ("" === e.style.display && Qe(e) && "none" === Ee.css(e, "display"))
      );
    },
    Ze = {};
  Ee.fn.extend({
      ...
      if (Be(e))
        for (
          n.handler && ((o = n), (n = o.handler), (i = o.selector)),
            i && Ee.find.matchesSelector(Ye, i),
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            et.test(t.type) && t.click && o(t, "input") && D(t, "click", E), !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            et.test(t.type) && t.click && o(t, "input") && D(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  Ee.extend({
    ...
    Ee.each(["height", "width"], function (e, t) {
      Ee.cssHooks[t] = {
        get: function (e, n, r) {
          if (n)
            return !mt.test(Ee.css(e, "display")) ||
    ...
    (Ee.cssHooks.marginLeft = I(me.reliableMarginLeft, function (e, t) {
      if (t)
        return (
      ...
      _default: {
        ...
        set: function (e) {
          Ee.fx.step[e.prop]
            ? Ee.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
              (!Ee.cssHooks[e.prop] && null == e.elem.style[F(e.prop)])
            ? (e.elem[e.prop] = e.now)
          ...
          return "undefined" == typeof e.getAttribute
            ...
            : ((1 === o && Ee.isXMLDoc(e)) ||
                (i =
                  ...
                  (Ee.expr.match.bool.test(t) ? kt : void 0)),
              void 0 !== n
                ? null === n
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : Nt.test(e.nodeName) || (Dt.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
              ...
              if (r)
                ...
                (void 0 !== e && "boolean" !== n) ||
                  ...
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
                      t || e === !1 ? "" : $e.get(this, "__className__") || ""
                    ));
            });
      },
      hasClass: function (e) {
  ...
  Ee.fn.extend({
    val: function (e) {
        ...
        i = this[0];
      {
        ...
        if (i)
          return (
            (t = Ee.valHooks[i.type] || Ee.valHooks[i.nodeName.toLowerCase()]),
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              ...
              (r = i[a]),
                (r.selected = Ee.inArray(Ee.valHooks.option.get(r), o) > -1) &&
                  (n = !0);
      ...
      if (
        ...
        for (o = 0; (a = d[o++]) && !t.isPropagationStopped(); )
          (p = a),
            ...
            (c =
              ($e.get(a, "events") || Object.create(null))[t.type] &&
              $e.get(a, "handle")),
            c && c.apply(a, n),
            (c = l && a[l]),
            c &&
    ...
    Ee.extend({
      ...
      ajax: function (t, n) {
        ...
        var i,
          ...
          h = Ee.ajaxSetup({}, n),
          g = h.context || h,
          v = h.context && (g.nodeType || g.jquery) ? Ee(g) : Ee.event,
          y = Ee.Deferred(),
  ...
  Ee.ajaxSetup({
    ...
    jsonpCallback: function () {
      var e = Zt.pop() || Ee.expando + "_" + Ot.guid++;
      return (this[e] = !0), e;
    },
  }),
    ...
    Ee.each(["top", "left"], function (e, t) {
      Ee.cssHooks[t] = I(me.pixelPosition, function (e, n) {
        if (n)
          return (n = M(e, t)), ft.test(n) ? Ee(e).position()[t] + "px" : n;
      });
    }),
  ...
  return (
    (Ee.noConflict = function (t) {
      return (
        e.$ === Ee && (e.$ = rn), t && e.jQuery === Ee && (e.jQuery = nn), Ee
      );
    }),
