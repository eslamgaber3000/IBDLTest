...
!(function (n, t) {
      ...
      (Array.from =
        ...
        function (n) {
          ...
          for (
            ...
            (u = o[s]),
              (c[s] = a ? (void 0 === r ? a(u, s) : a.call(r, u, s)) : u),
              (s += 1);
          return (c.length = l), c;
        }));
  var o = window,
  ...
  function pn(n) {
    fn.L("onClickOrTouch", { e: n, target: n.target });
  }
  function gn() {
  ...
  var wn = "fullpage-wrapper",
    ...
    Kn = "." + _n,
    Gn = "fp-prev",
    qn = ".fp-controlArrow.fp-prev",
    Yn = ".fp-controlArrow.fp-next",
    $n = {
      menu: !1,
      anchors: [],
      lockAnchors: !1,
  ...
  function ot() {
    if (!tt().anchors.length) {
      ...
      n.length &&
        n.length === p(tt().sectionSelector, Qn).length &&
        ((Xn = !0),
  ...
  var rt = function (n) {
    ...
    at = function (n, t) {
      (this.parent = this.parent || null),
        ...
        (this.item = n),
        (this.isVisible = d(n)),
        (this.isActive = m(n, An)),
        (this.an = m(n, In) || null != p(Hn, n)[0]),
        (this.un = t === tt().sectionSelector),
        (this.ln = F(n, Nn) || F(n, bn)),
        (this.index = function () {
  ...
  function pt(n, t) {
    !tt().autoScrolling || tt().scrollBar || (n.self != window && m(n, Cn))
      ? n.self != window && m(n, Cn)
        ? (n.scrollLeft = t)
        : n.scrollTo(0, t)
      : (n.style.top = t + "px");
  }
  function gt(n) {
    ...
    return j(n, Sn), y(n, { "-webkit-transition": t, transition: t });
  }
  function mt(n, t) {
    var e = n.index(),
      i = A(t, En);
  ...
  function kt(n, t, e, i) {
    var r,
      ...
      c = vn.K;
    dn({ K: !0 }),
      Mt && window.cancelAnimationFrame(Mt),
      (Mt = function (s) {
        r || (r = s);
        var f = Math.floor(s - r);
        if (vn.K) {
          var v = t;
          e && (v = o.fp_easings[tt().easing](f, a, u, e)),
            f <= e && pt(n, v),
            f < e
              ? window.requestAnimationFrame(Mt)
              : void 0 === i || l || (i(), dn({ K: !1 }), (l = !0));
        } else l || c || (i(), dn({ K: !1 }), (l = !0));
      }),
      window.requestAnimationFrame(Mt);
  }
  function Et(n) {
    ...
    var e = (function (n, t) {
      var e = {
        afterRender: function () {
          return { section: Et(hn().F), hn: Dt(hn().F.activeSlide) };
        },
        onLeave: function () {
          return {
  ...
  function Ht(n) {
    ...
    var t = F(this, En),
      e = p(zn, F(this, En))[0],
      i = lt(hn().C, t).slides[A(F(this, "li"))];
    fn.L("landscapeScroll", { slides: e, destination: i.item });
  }
  var Wt,
    Vt = {};
  function Ut(n, t, e) {
  ...
  function Kt() {
    ...
    m(this, Gn)
      ? _t().m.left &&
        (dn({ N: "slideArrow" }), fn.L("moveSlideLeft", { section: n }))
      : _t().m.right &&
        (dn({ N: "slideArrow" }), fn.L("moveSlideRight", { section: n }));
  }
  function Gt() {
    clearTimeout(Wt);
  }
  function qt(n, t, e) {
    ...
    (l.pn =
      ...
      (l.direction = l.direction ? l.direction : l.pn),
      l.localIsResizing || dn({ G: !1 }),
      tt().onSlideLeave &&
      !l.localIsResizing &&
      "none" !== l.pn &&
      Y(tt().onSlideLeave) &&
      !1 === jt("onSlideLeave", l)
        ...
        : (D(t, An),
          j(W(t), An),
          Oe(),
          l.localIsResizing || (Pt(l.prevSlide), Ct(t)),
          (function (n) {
            !tt().loopHorizontal &&
              tt().controlArrows &&
              (X(p(qn, n.section), 0 !== n.slideIndex),
              X(p(Yn, n.section), null != T(n.destiny)));
          })(l),
          a.isActive &&
            !l.localIsResizing &&
            Nt(l.slideIndex, l.slideAnchor, l.anchorLink),
          (function (n, t, e) {
            var i,
              o,
              r = t.destinyPos;
            if (
              ...
              (s.test.left[t.sectionIndex] = Math.round(r.left)),
                kt(n, Math.round(r.left), tt().scrollingSpeed, function () {
                  $t(t);
                });
          })(n, l));
  }
  ...
  function $t(n) {
    n.localIsResizing ||
      (Y(tt().afterSlideLoad) && jt("afterSlideLoad", n),
      dn({ G: !0 }),
      Lt(n.destiny),
      fn.L("afterSlideLoads", n)),
      dn({ H: !1 });
  }
  function Qt(n, t) {
    Tt(0, "internal"),
  ...
  function Jt(n, t) {
    ...
    if (tt().autoScrolling && !tt().scrollBar)
      y(Ot, { overflow: "hidden", height: "100%" }),
        j(At, "fp-scrollable"),
        Xt(et().recordHistory, "internal"),
        y(nt(), { "-ms-touch-action": "none", "touch-action": "none" }),
        null != e && St(e.offsetTop);
    else if (
      (y(Ot, { overflow: "visible", height: "initial" }),
      D(At, "fp-scrollable"),
      Xt(!!tt().autoScrolling && et().recordHistory, "internal"),
      y(nt(), { "-ms-touch-action": "", "touch-action": "" }),
      null != e)
    ) {
  ...
  function Zt() {
    var n =
      p(".fp-auto-height")[0] || (we() && p(".fp-auto-height-responsive")[0]);
    tt().lazyLoading &&
      n &&
  ...
  function te() {
    ...
    var e = p(jn)[0];
    D(e, "fp-" + tt().navigationPosition),
      tt().showActiveTooltip && D(e, "fp-show-active");
  ...
  function ee(n) {
    ...
    fn.L("scrollPage", { destination: hn().C[t] });
  }
  function ie(n, t) {
    var e;
    (e = n),
      tt().menu &&
        ...
        p(tt().menu).forEach(function (n) {
          null != n &&
            (j(p(xn, n), An), D(p('[data-menuanchor="' + e + '"]', n), An));
        }),
      (function (n, t) {
        var e = p(jn)[0];
        tt().navigation &&
          ...
          (j(p(xn, e), An),
          D(n ? p('a[href="#' + n + '"]', e) : p("a", p("li", e)[t]), An));
      })(n, t);
  }
  (Vt.m = { up: !0, down: !0, left: !0, right: !0 }),
    (Vt.k = g({}, Vt.m)),
    fn.j("onClickOrTouch", function (n) {
      var t = n.target;
      (Q(t, Kn) || F(t, Kn)) && Kt.call(t, n);
    }),
    (s.landscapeScroll = qt),
    fn.j("bindEvents", function () {
      fn.j("onPerformMovement", Gt);
    }),
    (s.setRecordHistory = Xt),
    (s.setAutoScrolling = Jt),
    (s.test.setAutoScrolling = Jt),
    new Date().getTime();
  var oe,
    re,
    ae,
      ...
      if (
        ...
        if (
          ...
          if (
            ...
            (u.direction = l),
            Y(tt().beforeLeave) && !1 === fe("beforeLeave", u))
          )
            return;
        ...
        tt().autoScrolling &&
          ...
          (u = (function (n) {
            ...
            var t = hn().F.item;
            return (
              n.isMovementUp ? B(t, tn(t, En)) : N(t, en(t, En).reverse()),
              St(hn().F.item.offsetTop),
              (function () {
                for (var n = p(Pn), t = 0; t < n.length; t++)
                  Qt(n[t], "internal");
              })(),
              (n.mn = t),
              (n.dtop = n.element.offsetTop),
              (n.yMovement = mt(hn().F, n.element)),
              n
            );
          })(u)),
          u.localIsResizing || Pt(hn().F.item),
          D(i, An),
          j(W(i), An),
          Oe(),
          Ct(i),
          ...
          (function (n) {
            ...
            if (
              ...
              (s.test.top = -n.dtop + "px"),
                clearTimeout(le),
                kt(i.element, i.options, tt().scrollingSpeed, function () {
                  tt().scrollBar
                    ? (le = setTimeout(function () {
                        de(n);
                      }, 30))
  ...
  function de(n) {
    dn({ B: !1 }),
      ...
      Y(tt().afterLoad) && !n.localIsResizing && jt("afterLoad", n),
      Oe(),
      n.localIsResizing || Lt(n.element),
      D(n.element, On),
      j(W(n.element), On),
      Zt(),
      Me.bn(),
      dn({ G: !0 }),
      fn.L("afterSectionLoads", n),
  ...
  function me(n) {
    ...
    n
      ? t ||
        ...
        O(p(jn)),
        D(At, yn),
        Y(tt().afterResponsive) && tt().afterResponsive.call(nt(), n))
      : t &&
        (Jt(et().autoScrolling, "internal"),
        he(et().autoScrolling, "internal"),
        k(p(jn)),
        j(At, yn),
        Y(tt().afterResponsive) && tt().afterResponsive.call(nt(), n));
  }
  ...
  function be(n) {
    tt().verticalCentered &&
      ((!tt().scrollOverflow && Me.yn(n.item)) ||
        Me.Sn(n) ||
        m(n.item, Bn) ||
        D(n.item, Bn));
  }
  ...
  var Te,
    Me = {
      ...
      Mn: function () {
        tt().scrollOverflowMacStyle && !u && D(At, "fp-scroll-mac"),
          hn().vn.forEach(function (n) {
            if (
              !(
                (n.slides && n.slides.length) ||
                (m(n.item, "fp-auto-height-responsive") && we())
              )
            ) {
              var t,
                e = vt(n.item),
      ...
      jn: function (n) {
        Me.En(n).addEventListener("scroll", Me.Ln),
          n.addEventListener("wheel", Me.kn, { passive: !1 }),
          n.addEventListener("keydown", Me.kn, { passive: !1 });
      },
      Dn: function (n) {
      ...
      Pn: function (n, t) {
        if (!vn.G) return !1;
        var e = Me.En(t);
        if (!tt().scrollOverflow || !m(e, In) || m(vt(t), "fp-noscroll"))
          return !0;
        var i = c ? 1 : 0,
          o = e.scrollTop,
          r = "up" === n && o <= 0,
      ...
      Ln:
        ...
        function (n) {
          var t = n.target.scrollTop,
            e = "none" !== vn.q ? vn.q : Te < t ? "down" : "up";
          (Te = t),
            Y(tt().onScrollOverflow) &&
              jt("onScrollOverflow", { position: t, direction: e }),
            m(n.target, In) &&
              vn.G &&
              Me.Pn(e, n.target) &&
              Me.Cn() &&
              fn.L("onScrollOverflowScrolled", { direction: e });
        }),
    },
    Ae = null,
    xe = null;
    ...
    (vn.F = null),
      ...
      (function () {
        ...
        if (!n && vn.C.length && !hn().B && Ae) {
          var i = De(Ae, vn.C);
          i && ((vn.F = i), (vn.F.isActive = !0), D(vn.F.item, An)),
            vn.F && St(vn.F.item.offsetTop);
        }
        if (t && !e && xe) {
          ...
          o &&
            ...
            D(vn.F.activeSlide.item, An)),
            vn.F.activeSlide && Qt(vn.F.activeSlide.item, "internal");
        }
      })();
  }
  function ke() {
    var n = p(tt().sectionSelector, nt()),
      t = h(n),
    ...
    (Ae = Ee(vn.F)),
      (xe = Ee(vn.F ? vn.F.activeSlide : null)),
      (vn.R = t.length),
  ...
  var je = function (n) {
    ...
    [].push.call(arguments, tt().sectionSelector),
      ...
      (this.Tn = p(tt().slideSelector, n)),
      (this.zn = Array.from(this.Tn).map(function (n) {
        return new Re(n, t);
      })),
  ...
  function Ce(n) {
    ...
    y(p(Nn, n.item), { width: o + "%" }),
      ...
      i.forEach(function (n) {
        y(n.item, { width: a + "%" }), tt().verticalCentered && be(n);
      });
    var c = n.activeSlide || null;
    null != c &&
    vn.F &&
    (0 !== vn.F.index() || (0 === vn.F.index() && 0 !== c.index()))
      ? Qt(c.item, "internal")
      : D(e[0], An);
  }
  (Re.prototype = at.prototype), (Re.prototype.constructor = je);
  var ze = { attributes: !1, subtree: !0, childList: !0, characterData: !0 };
  function Fe() {
    return h(p(tt().slideSelector, nt())).length !== hn().P;
  }
  function Ne(n) {
    var t = Fe();
    (Fe() || h(p(tt().sectionSelector, nt())).length !== hn().R) &&
      !vn.en &&
      (tt().observer && Le && Le.disconnect(),
      ke(),
      Oe(),
      (tt().anchors = []),
      Z(p(jn)),
  ...
  function Je() {
    var n = hn().F.next();
    n || (!tt().loopBottom && !tt().continuousVertical) || (n = hn().C[0]),
      null != n
        ? ve(n, null, !1)
        : nt().scrollHeight < At.scrollHeight && fn.L("scrollBeyondFullpage");
  }
  function Ze() {
    var n = hn().F.prev();
    n || (!tt().loopTop && !tt().continuousVertical) || (n = rn(hn().C)),
      null != n && ve(n, null, !0);
  }
  ...
  function ti(n) {
    tt().autoScrolling &&
      (vn.G &&
        (n.pageY < ni && _t().m.up
          ? Ze()
          : n.pageY > ni && _t().m.down && Je()),
      (ni = n.pageY));
  }
  function ei(n) {
    if (_t().m[n]) {
      var t = "down" === n ? Je : Ze;
      tt().scrollOverflow && Me.Sn(hn().F)
        ? Me.Pn(n, hn().F.item) && Me.Cn() && t()
        : t();
    }
  }
  var ii,
    ...
    si = 0,
      ...
      (o.PointerEvent && (ai = { down: "pointerdown", move: "pointermove" }),
      ai),
    vi = {
  ...
  function di(n) {
    var t = F(n.target, En) || hn().F.item,
      e = Me.Sn(hn().F);
    if (hi(n)) {
      dn({ X: !0, J: !1 }), tt().autoScrolling && (!e || (e && !vn.G)) && V(n);
      var i = mi(n);
      (ci = i.y), (si = i.x);
      var r = Math.abs(ui - ci) > (o.innerHeight / 100) * tt().touchSensitivity,
        a = Math.abs(li - si) > (b() / 100) * tt().touchSensitivity,
        u = p(zn, t).length && Math.abs(li - si) > Math.abs(ui - ci),
        l = ui > ci ? "down" : "up";
      dn({ q: u ? (li > si ? "right" : "left") : l }),
        u
          ? !vn.H &&
            a &&
            (li > si
              ? _t().m.right && fn.L("moveSlideRight", { section: t })
              : _t().m.left && fn.L("moveSlideLeft", { section: t }))
  ...
  function pi(n) {
    if ((tt().fitToSection && dn({ K: !1 }), hi(n))) {
      var t = mi(n);
      (ui = t.y), (li = t.x);
    }
    K("touchend", gi);
  ...
  function ki(n) {
    ...
    var t,
      e = n.keyCode,
      i = [37, 39].indexOf(e) > -1,
      o = tt().autoScrolling || tt().fitToSection || i;
    9 === e
      ? (function (n) {
          var t = n.shiftKey,
            e = r.activeElement,
        ...
        (oi = setTimeout(function () {
          !(function (n) {
            var t = n.shiftKey,
              ...
              o = Me.Pn("up", hn().F.item),
              a = Me.Pn("down", hn().F.item),
            ...
            if (
              ...
              switch ((dn({ N: "keydown" }), n.keyCode)) {
                case 38:
                case 33:
                  _t().k.up && o && (vn.B ? fn.L("onKeyDown", { e: n }) : Ze());
                  break;
                case 32:
                  if (t && _t().k.up && !i && o) {
                    Ze();
  ...
  (s.moveSlideLeft = yi),
    ...
    fn.j("bindEvents", function () {
      K("blur", Di),
        ...
        _("keyup", Ei),
        fn.j("onDestroy", Oi),
        fn.j("afterSlideLoads", ji),
        fn.j("afterSectionLoads", Li);
    });
    ...
    n
      ? ((function () {
          ...
          var e =
            ...
            i = Ie();
          "DOMMouseScroll" == e
            ? r[n](t + "MozMousePixelScroll", Ni, i)
            : r[n](t + e, Ni, i);
        })(),
        nt().addEventListener("mousedown", Bi),
        nt().addEventListener("mouseup", Ii))
      : (r.addEventListener
          ? (G("mousewheel", Ni, !1),
            G("wheel", Ni, !1),
            G("MozMousePixelScroll", Ni, !1))
          : r.detachEvent("onmousewheel", Ni),
        nt().removeEventListener("mousedown", Bi),
        nt().removeEventListener("mouseup", Ii));
  }
  function Ni(n) {
    var t = new Date().getTime(),
      ...
      i = (function (n, t) {
        new Date().getTime();
        var e =
            hn().B && n.getBoundingClientRect().bottom >= 0 && "up" === _e.In(),
          i = hn().Hn;
        if (i) return V(t), !1;
        if (hn().B) {
          if (e) {
            var o;
            if (!(i || (Xe("isNewKeyframe", "beyondFullpage") && _e.Bn())))
              return (
                (o = ht(
                  rn(hn().C).item.offsetTop + rn(hn().C).item.offsetHeight
            ...
            if (_e.Bn())
              return (
                (e = !1), dn({ Hn: !0 }), dn({ N: "wheel" }), qe(), V(t), !1
              );
          } else Xe("set", "beyondFullpage", 1e3);
          if (!i && !e) return !0;
        }
      })(nt(), n);
    if ((vn.J || dn({ X: !1, J: !0, q: "none" }), !_t().m.down && !_t().m.up))
      return V(n), !1;
    if (i) return !0;
    if (!1 === i) return V(n), !1;
    if (tt().autoScrolling && !ii && !e) {
      ...
      return (
        ...
        vn.G &&
          an(zi, 10) >= an(zi, 70) &&
          l &&
          (dn({ N: "wheel" }), ei(a < 0 ? "down" : "up")),
        !1
      );
    }
    tt().fitToSection && dn({ K: !1 });
  }
  function Bi(n) {
    var t;
    2 == n.which &&
      ((t = n.pageY), (ni = t), nt().addEventListener("mousemove", ti));
  }
  function Ii(n) {
    ...
    n
      ? (Fi(!0),
        (function () {
          if (vi.Wn && (a || l)) {
            tt().autoScrolling &&
              (At.removeEventListener(vi.Wn, wi, { passive: !1 }),
              At.addEventListener(vi.Wn, wi, { passive: !1 }));
            var n = tt().touchWrapper;
            n.removeEventListener(vi.Vn, pi),
              n.removeEventListener(vi.Wn, di, { passive: !1 }),
              n.addEventListener(vi.Vn, pi),
              n.addEventListener(vi.Wn, di, { passive: !1 });
          }
        })())
      : (Fi(!1),
        (function () {
          if (vi.Wn && (a || l)) {
            tt().autoScrolling &&
              (At.removeEventListener(vi.Wn, di, { passive: !1 }),
              At.removeEventListener(vi.Wn, wi, { passive: !1 }));
            var n = tt().touchWrapper;
            n.removeEventListener(vi.Vn, pi),
              n.removeEventListener(vi.Wn, di, { passive: !1 });
            ...
            .forEach(function (n) {
              if (!e) {
                var t = Q(i, n),
                  o = F(i, n);
                (t || o) &&
                  (s.shared.Gn || Hi(!1), (s.shared.Gn = !0), (e = !0));
              }
            }),
          !e && s.shared.Gn && (Hi(!0), (s.shared.Gn = !1))))
      : Hi(!0);
  }
  function Ki(n, t) {
        ...
        !(function () {
          if (
            ...
            if (!Q(n, "textarea") && !Q(n, "input") && !Q(n, "select")) {
              var t = w();
              Math.abs(t - Yi) > (20 * Math.max(Yi, t)) / 100 &&
                (Zi(!0), (Yi = t));
            }
          } else
            (e = w()),
              (i = b()),
              (vn.tn === e && $i === i) || (dn({ tn: e }), ($i = i), Zi(!0));
          var e, i;
          dn({ W: !1 });
        })(),
          (Qi = !1);
  ...
  function Zi(n) {
    if (!m(nt(), Tn)) {
      ...
      vn.B || (a && Ki(a + 1)),
        ...
        Y(tt().afterResize) &&
          n &&
          tt().afterResize.call(nt(), o.innerWidth, o.innerHeight),
        Y(tt().afterReBuild) && !n && tt().afterReBuild.call(nt()),
        $(nt(), "afterRebuild");
    }
  }
  function no(n) {
  ...
  function io() {
    if (!vn.V && !tt().lockAnchors) {
      ...
      t &&
        ...
        fn.L("onScrollPageAndSlide", { Kn: t, slideAnchor: e });
    }
  }
  function oo(n) {
    var t = n.target;
  ...
  function ro(n) {
    dn({ N: "menu" }),
      !p(tt().menu)[0] ||
        ...
        (V(n), fn.L("onMenuClick", { anchor: U(this, "data-menuanchor") }));
  }
  function ao(n) {
    var t = n.target;
    t && F(t, "#fp-nav a")
      ...
      : Q(t, ".fp-tooltip")
      ? ne.call(t)
      : (Q(t, Un) || null != F(t, Un)) && Ht.call(t, n.e);
  }
  (s.reBuild = Zi),
    fn.j("bindEvents", function () {
  ...
  function so(n) {
    ...
    if (
      ...
      hn().F &&
      (rn(hn().C),
      !hn().B && !hn().Hn && (!tt().autoScrolling || tt().scrollBar))
    ) {
      var a = H(),
        u = (function (n) {
          var t = n > co ? "down" : "up";
          return (co = n), dn({ nn: n }), t;
        })(a),
        l = 0,
        c = a + w() / 2,
        s = At.scrollHeight - w() === a,
        f = hn().C;
      if ((dn({ scrollY: a }), s)) l = f.length - 1;
      else if (a)
        for (var v = 0; v < f.length; ++v) f[v].item.offsetTop <= c && (l = v);
      else l = 0;
      if (
        ((i = u),
        ...
        (r = o + w()),
        ("up" == i ? r >= H() + w() : o <= H()) &&
          (m(hn().F.item, On) || (D(hn().F.item, On), j(W(hn().F.item), On))),
        (e = (t = f[l]).item),
        !t.isActive)
      ) {
        dn({ V: !0 });
        ...
        T && ((h = T.anchor), (d = T.index())),
          vn.G &&
            (D(e, An),
            j(W(e), An),
            Y(tt().beforeLeave) && fe("beforeLeave", M),
            Y(tt().onLeave) && jt("onLeave", M),
            Y(tt().afterLoad) && jt("afterLoad", M),
            Pt(p),
            Ct(e),
            Lt(e),
            ie(y, S - 1),
            tt().anchors.length && dn({ U: y }),
            Nt(d, h, y),
            Oe()),
          clearTimeout(uo),
  ...
  function vo(n) {
    var t = n.index();
    void 0 !== tt().anchors[t] && n.isActive && ie(tt().anchors[t], t),
      tt().menu &&
        tt().css3 &&
        null != F(p(tt().menu)[0], bn) &&
        p(tt().menu).forEach(function (n) {
          At.appendChild(n);
        });
  }
  function ho() {
    ...
    D(i, On),
      ...
      Lt(i),
      (t = Ti((n = to()).section)),
      (n.section && t && (void 0 === t || t.index() !== A(ye))) ||
        !Y(tt().afterLoad) ||
        jt("afterLoad", {
          F: i,
          element: i,
  ...
  function mo() {
    ke(),
      ...
      ot(),
      (function () {
        y(ln(nt(), "body"), { height: "100%", position: "relative" }),
          D(nt(), wn),
          D(xt, Mn),
          dn({ tn: w() }),
          j(nt(), Tn),
        ...
        tt().fixedElements &&
          ...
          tt().navigation && te(),
          p('iframe[src*="youtube.com/embed/"]', nt()).forEach(function (n) {
            var t, e;
            (e = U((t = n), "src")),
              t.setAttribute(
                "src",
      ...
      po(!0),
      Hi(!0),
      Jt(tt().autoScrolling, "internal"),
      ge(),
      zt(),
      "complete" === r.readyState && go(),
      K("load", go),
      ho(),
      ke(),
      Oe();
  ...
  function wo() {
    ...
    "" === tt().licenseKey.trim()
      ...
      : (tt() && vn.Yn) || r.domain.indexOf("alvarotrigo.com") > -1
      ? n && n.length
      : (v(
          "error",
      ...
      return (
        ...
        (s.test = Object.assign(s.test, {
          ...
          gn: (function () {
            for (
              var n = [], t = 0;
              t < p(tt().sectionSelector, nt()).length;
              t++
            )
        ...
        (s.shared = Object.assign(s.shared, { $n: null, Gn: !1 })),
        (o.fullpage_api = s),
        nt() && (fn.L("beforeInit"), mo(), fn.L("bindEvents")),
        o.fullpage_api
      );
    wo();
  }
  return (
    ...
    fn.j("bindEvents", function () {
      K("scroll", so),
        r.body.addEventListener("scroll", so),
        fn.j("onScrollPageAndSlide", function (n) {
    ...
    fn.j("bindEvents", function () {
      fn.j("onDestroy", Yt),
        fn.j("landscapeScroll", function (n) {
      ...
      fn.j("onInitialise", function () {
        ...
        dn({
          Yn:
            ...
            (u &&
              ((tt().credits && u && e <= u.Qn && u.Jn === t.split(n[0])[4]) ||
                (function (n) {
                  var t = i[o()]().join("");
    ...
    (s.setKeyboardScrolling = fo),
    (s.shared.$n = ho),
    (s.setAllowScrolling = po),
    (s.destroy = function (n) {
      Jt(!1, "internal"),
        ...
        n &&
          ...
          y(ut(hn().C), { height: "", "background-color": "", padding: "" }),
          y(ut(hn().slides), { width: "" }),
          y(nt(), {
            height: "",
            position: "",
            "-ms-touch-action": "",
          ...
          y(Ot, { overflow: "", height: "" }),
          j(xt, Mn),
          j(At, yn),
          At.className.split(/\s+/).forEach(function (n) {
            0 === n.indexOf("fp-viewing") && j(At, n);
          }),
          ut(hn().vn).forEach(function (n) {
            tt().scrollOverflow && Me.Rn(n),
              j(n, "fp-table active " + On),
              U(n, "data-fp-styles") &&
                n.setAttribute("style", U(n, "data-fp-styles")),
              m(n, kn) && !Xn && n.removeAttribute("data-anchor");
          }),
          wt(nt()),
          [Dn, Nn, zn].forEach(function (n) {
            p(n, nt()).forEach(function (n) {
              z(n);
            });
          }),
          y(nt(), { "-webkit-transition": "none", transition: "none" }),
          o.scrollTo(0, 0),
          [kn, Ln, Fn].forEach(function (n) {
            j(p("." + n), n);
          }));
    }),
