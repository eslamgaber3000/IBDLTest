                ...
                <div style="color:white;overflow:visible" class="container">
                    ...
                    <div class="collapse navbar-collapse" id="main_nav">
                        <ul class="navbar-nav mb-lg-0">
                                ...
                                <div class="dropdown-menu megamenu sm-menu" aria-labelledby="dropdown01"
                                    ...
                                    <div style="justify-content: start;margin-left:3em" class="menuSpace d-flex">
                                        ...
                                        <div class="col-7">
                                            ...
                                            <div class="d-flex">
                                                <div style="" class="mb-3 ms-4">
                                                    ...
                                                    <a class="dropdown-item" href="{{url('pages/about')}}"> About
                                                        IBDL</a>
                                                    <a class="dropdown-item" href="{{url('pages/strategy')}}">
                                                        Strategy</a>
                                                    <a class="dropdown-item" href="{{url('pages/ceo')}}"> CEO
                                                        Statement</a>
                                                    {{-- <a class="dropdown-item" href="{{url('pages/become_member')}}">
                                                        Become a
                                                        Member </a> --}}
                                                    <a class="dropdown-item" href="{{url('pages/board_of_trustees')}}">
                                                        Board of Trustees</a>
                                                    {{-- <a class="dropdown-item" href="{{url('pages/collaboration')}}">
                                                        Collaboration</a> --}}
                                                    <a class="dropdown-item"
                                                        href="{{url('pages/'.'body_of_knowledge')}}">
                                                        Body of knowledge</a>
                                                    <a class="dropdown-item" href="{{url('pages/'.'portfolio')}}"> Proud
                                                        to
                                                        Serve</a>
                                                    <a class="dropdown-item" href="{{url('pages/'.'code_of_ethics')}}">
                                                        Code of Ethics</a>
                                                </div>
                                            </div>
                                        ...
                                        <div style=";align-self:center" class="col-4 px-xxl-4 px-3 ">
                                            <div style="" class="">
                                                <img src="{{ asset('images/about.png') }}" class="img-fluid mx-auto"
                                                    alt="" />
                                            </div>
                                        </div>
                            ...
                            @if (session('ver') === 'full' || session('ver') === 'corporate' || !session('ver'))
                            <li class="nav-item dropdown megamenu-li dmenu">
                                ...
                                <div class="dropdown-menu megamenu sm-menu" aria-labelledby="dropdown02"
                                    ...
                                    <div style="justify-content: start;" class="d-flex menuSpace ms-5">
                                        <div class="col-10 mb-5">
                                            ...
                                            <div class="d-flex ms-4">
                                                <div style="border-right:1px solid #696969;" class="col-lg-3">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{url('qualifications/essential')}}">IBDL
                                                        Essential </a>
                                                    <a class="dropdown-item"
                                                        href="{{url('qualifications/professional')}}">IBDL
                                                        Professional</a>
                                                    <a class="dropdown-item"
                                                        href="{{url('qualifications/master')}}">IBDL
                                                        Master</a>
                                                    <a class="dropdown-item" href="{{url('qualifications/ce')}}">
                                                        Certified
                                                        Educator
                                                    </a>
                                                ...
                                                <div style="border-right:1px solid #696969;" class="col-lg-3 ps-4">
                                                    ...
                                                    <a class="dropdown-item" href="{{url('assessments/win_v_war')}}">
                                                        Win vs.
                                                        War
                                                    </a>
                                                    <a class="dropdown-item"
                                                        href="{{url('assessments/master_board_game')}}">
                                                        Master Board Game </a>
                                                    <a class="dropdown-item" href="{{url('assessments/sparta')}}">
                                                        Sparta </a>
                                                    <a class="dropdown-item" href="{{url('assessments/maven')}}"> Maven
                                                    </a>
                                                    <a class="dropdown-item" href="{{url('assessments/mogul')}}"> Mogul
                                                        CEO
                                                    </a>
                                                    <a class="dropdown-item" href="{{url('assessments/micromatic')}}">
                                                        Micromatic
                                                    </a>
                                                </div>
                                                <div style="border-right:1px solid #696969;" class="col-lg-3 ps-4">

                                                    <a class="dropdown-item" href="{{url('assessments/pqp')}}"> PQP </a>
                                                    <a class="dropdown-item" href="{{url('assessments/cpat')}}"> CPAT
                                                    </a>
                                                </div>
                                                <div style="" class="col-lg-3 ps-4">

                                                    <a class="dropdown-item" href="{{url('executive_education/aelp')}}">
                                                        Executive
                                                        Leadership Program
                                                    </a>
                                                    <a class="dropdown-item" href="{{url('executive_education/ewlp')}}">
                                                        Women
                                                        Leadership Program
                                                    </a>
                                                    <a class="dropdown-item"
                                                        href="{{url('executive_education/economic_diplomacy')}}">
                                                        Economic Diplomacy Program
                                                    </a>
                                                    <a class="dropdown-item"
                                                        href="{{url('executive_education/digital_diplomacy')}}">
                                                        Digital Diplomacy Program
                                                    </a>
                                                    {{-- <a class="dropdown-item"
                                                        href="{{url('executive_education/cldo')}}"> CLDO
                                                    </a> --}}
                                                    <a class="dropdown-item" href="{{url('executive_education/lfc')}}">
                                                        Future
                                                        Creation Program </a>
                                        ...
                                        <div style="height:364px;background-color:whitesmoke;border-top-right-radius: 14px;border-bottom-right-radius: 15px;"
                                            class="col-2 d-flex">
                                            <div style="border-top-right-radius: 14px;padding: 1.5em 1em 1em 1em;border:none;align-self:center;height:auto"
                                                class="nav-icon d-flex flex-column">
                                                <a class="m-auto" href="{{url('pages/find_local_chapter')}}">
                                                    <img style="padding: 1.6em 3em;"
                                                        src="{{ asset('images/map-icon.png') }}"
                                        ...
                                        @else
                                        <div style="height:364px;background-color:whitesmoke;border-top-right-radius: 14px;border-bottom-right-radius: 15px"
                                            class="col-2 d-felx flex-column">
                                            <div style="border-top-right-radius: 14px;padding: 1.5em 1em 1em 1em;"
                                                class="nav-icon d-flex flex-column">
                                                <a class="m-auto" href="{{url('pages/find_local_chapter')}}">
                                                    <img src="{{ asset('images/map-icon.png') }}"
                                            ...
                                            <hr> --}}
                                            {{-- <div
                                                style="border-bottom-right-radius: 15px;padding: 1.5em 1em 1em 1em;"
                                                class="nav-icon d-flex flex-column">
                                                <a class="m-auto" target="_blank" href="{{ route('Demo.Index')}}">
                                                    <img src="{{ asset('images/demo-icon.png') }}"
                                                        class="img-fluid mx-auto px-5 pb-2 pt-2" alt="" />
                                                ...
                                                <div style="border-top-right-radius: 14px;padding: 1em 0em 1em 0em;border:none;align-self:center;height: 100%;border-bottom-right-radius: 14px;"
                                                    ...
                                                    <a class="m-auto" target="_blank" href="{{ route('Demo.Index')}}">
                                                        <img style=" height: 40%;margin-top:5em"
                                                            src="{{ asset('images/demo-icon.png') }}"
                                                            class="img-fluid mx-auto px-5 pb-2 pt-2" alt="" />
                                                        <P>Test Your Skills <br> (Demo Exam)</P>
                                                    </a>
                                                </div>
                                        ...
                                        <div class="col-9 mb-5">
                                            ...
                                            <div class="d-flex ms-4">
                                                <div style="border-right:1px solid #696969;" class="col-lg-5">
                                                    ...
                                                    <a class="dropdown-item" href="{{url('pages/essential')}}">IBDL
                                                        Essential </a>
                                                    <a class="dropdown-item" href="{{url('pages/professional')}}">IBDL
                                                        Professional</a>
                                                    <a class="dropdown-item" href="{{url('pages/master')}}">IBDL
                                                        Master</a>
                                                    <a class="dropdown-item" href="{{url('pages/ce')}}"> Certified
                                                        Educator
                                                    </a>
                                                    <a class="dropdown-item" href="{{url('pages/cie')}}"> Certified
                                                        Industrial Engineer </a>
                                                    <!--<a class="dropdown-item" href="{{url('pages/colp')}}"> Certified-->
                                                    <!--    Organizational Learning Professional </a>-->
                                                </div>

                                                <div style="" class="col-lg-5 ps-4">

                                                    <a class="dropdown-item" href="{{url('pages/pqp')}}"> PQP </a>
                                                    <a class="dropdown-item" href="{{url('pages/cpat')}}"> CPAT </a>
                                                </div>
                                        ...
                                        <div class="col-10 mb-4">
                                            ...
                                            <div class="d-flex ">
                                                ...
                                                <div style="width: 30%;border-right:1px solid #696969;"
                                                    ...
                                                    <a class="dropdown-item" href="{{url('pages/win_v_war')}}"> Win vs.
                                                        War
                                                    </a>
                                                    <a class="dropdown-item" href="{{url('pages/master_board_game')}}">
                                                        Master Board Game </a>
                                                    <a class="dropdown-item" href="{{url('pages/sparta')}}"> Sparta </a>
                                                    <a class="dropdown-item" href="{{url('pages/maven')}}"> Maven </a>
                                                    <a class="dropdown-item" href="{{url('pages/mogul')}}"> Mogul CEO
                                                    </a>
                                                    <a class="dropdown-item" href="{{url('pages/micromatic')}}">
                                                        Micromatic
                                                    </a>
                                                </div>
                            ...
                            @if (session('ver') === 'full' || !session('ver') )
                            <li class="nav-item dropdown megamenu-li dmenu">
                                    ...
                                    <div class="d-flex menuSpace ms-5">
                                        ...
                                        <div class="col-10" style="width:80%">
                                            ...
                                            <div class="d-flex ">
                                                <div style="margin-left: 2em;border-right:1px solid #696969;width:40%"
                                                    ...
                                                    <a class="dropdown-item" href="{{url('pages/solutions_business')}}">
                                                        Solutions
                                                        for Business </a>
                                                    <a class="dropdown-item" href="{{url('pages/solutions_banks')}}">
                                                        Solutions
                                                        for
                                                        Banks </a>
                                                ...
                                                <div style="width:40%" class="col-5 border-right me-4 mb-3">
                                                    ...
                                                    {{-- <a class="dropdown-item"
                                                        href="{{url('pages/academic_accreditation')}}">
                                                    ...
                                                    {{-- <a class="dropdown-item"
                                                        ...
                                                        Professional Corporate Trainer Accreditation </a> --}}
                                                    <a class="dropdown-item"
                                        ...
                                        <div style="width: 20%;height:350px" class="col-2">
                                            <div style="border-bottom-right-radius: 15px;padding: 1em 0em 1em 0em;height:100%"
                                                ...
                                                <a class="" href="{{url('pages/request_customized_training')}}">
                                                    <img style="height: auto;padding:0px 4em"
                                                        src="{{ asset('images/CustomTraining.png') }}"
                            ...
                            <li class="nav-item dropdown megamenu-li dmenu">
                                ...
                                <div class="dropdown-menu megamenu sm-menu" aria-labelledby="dropdown03"
                                    ...
                                    <div class="d-flex menuSpace ms-5">
                                        ...
                                        {{-- <div style="border-top-right-radius: 14px;border-bottom-right-radius: 15px"
                                            class="col-2">
                                            <a style="padding: 2em 0;border-top-right-radius: 14px;border-bottom-right-radius: 15px"
                                                href="{{url('pages/find_local_chapter')}}"
                                                style="border-top-right-radius: 14px;background-color:whitesmoke;border-top-right-radius: 14px;border-bottom-right-radius: 15px"
                                                class="nav-icon d-flex flex-column">
                                                <img style="padding: 3em 3em 1em 3em"
                                                    src="{{ asset('images/map-icon.png') }}" class="img-fluid mx-auto "
                                                    alt="" />
                                                <p>Become A Member</p>
                                            </a>
                            ...
                            <li class="nav-item dropdown megamenu-li dmenu">
                                ...
                                <div class="dropdown-menu megamenu sm-menu" aria-labelledby="dropdown03"
                                    ...
                                    <div class="d-flex menuSpace ms-5">
                                        ...
                                        <div class="col-2">
                                            <a href="{{url('pages/request_customized_training')}}">
                                                style="border-top-right-radius: 14px;padding: 1em 0.5em 1em 0.5em;"
                                                class="nav-icon d-flex flex-column">
                                                <img src="{{ asset('images/CustomTraining.png') }}"
                                                    class="img-fluid mx-auto px-5 pb-2 pt-2" alt="" />
                                                <p>Request a Customized Training</p>
                                            </a>
                                            {{--
                                            <hr>
                                            <div style="border-bottom-right-radius: 15px;padding: 1em 0.5em 1em 0.5em;"
                                                class="nav-icon d-flex flex-column">

                                                <img src="{{ asset('images/demo-icon.png') }}"
                                                    class="img-fluid mx-auto px-5 pb-2 pt-3" alt="" />
                                                <P>Become a Member </P>
                                            </div> --}}
                                        </div>
                                    </div>
                            ...
                            <li class="nav-item dropdown megamenu-li dmenu">
                                ...
                                <div class="dropdown-menu megamenu sm-menu" aria-labelledby="dropdown03"
                                    ...
                                    <div class="d-flex menuSpace ms-5">
                                        ...
                                        {{-- <div class="col-3">
                                            <a href="{{url('pages/find_local_chapter')}}"
                                                style="border-top-right-radius: 14px;padding: 1em 0.5em 1em 0.5em;"
                                                class="nav-icon d-flex flex-column">
                                                <img src="{{ asset('images/map-icon.png') }}"
                                                    class="img-fluid mx-auto px-5 pb-2 pt-2" alt="" />
                                        ...
                                        <div class="d-flex">
                                            <div style="margin-top: 0.9em" class="col-7">
                                                ...
                                                <div style="margin-left: 1.5em" class=" mb-5">
                                                    <a style="font-size:13px" class="dropdown-item"
                                                        href="{{url('pages/news')}}"> News &
                                                        Events</a>
                                                    <a style="font-size:13px" class="dropdown-item"
                                                        href="{{url('pages/magazine')}}">
                                            ...
                                            <div class="col-2 offset-2 pb-1">
                                                <div style="margin-bottom: 1em;margin-top:-1em" class="">
                                                    <img src="{{ asset('images/media.png') }}" class="img-fluid mx-auto"
                                                        alt="" />
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <li class="nav-item">
                                <a href="{{url('Article/index')}}" style="cursor: pointer" class="nav-link"> IBDL Blog
                        ...
                        {{-- <ul class="list-unstyled no-margin links" style="margin-left: auto;">
                            <li>
                                <a href="">
                                     <strong><i class="fa-solid fa-shopping-cart"></i> store</strong>
                                    <!--<i class="fa-solid fa-shopping-cart"></i> store-->
                                </a>
                            </li>
                            <li>
                                ...
                                <a href="{{ route('dashboard') }}">
                                    <i style="color:white" class="fa-solid fa-user fa-xl"></i>
                                </a>
                                @else
                                <div class="dropdown me-1 dropdown-center">
                                    <button style="color: white;background-color: transparent;" class="btn"
                                        type="button" data-bs-toggle="dropdown" aria-expanded="false"
                                        data-bs-offset="10,20">
                                        <i style="color: white" class="fa-solid fa-user"></i> Sign In <i
                                            style="color: white" class="fa-solid fa-angle-down"></i>
                                    </button>
