...
} elseif ($_instance->childHasBeenRendered('1huuwe9')) {
    $componentId = $_instance->getRenderedChildComponentId('1huuwe9');
    $componentTag = $_instance->getRenderedChildComponentTagName('1huuwe9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1huuwe9');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('1huuwe9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH /home/u101566037/domains/ibdl.net/public_html/blog/vendor/filament/filament/src/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>