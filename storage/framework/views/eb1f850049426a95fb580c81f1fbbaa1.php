...
} elseif ($_instance->childHasBeenRendered('tpMj7ws')) {
    $componentId = $_instance->getRenderedChildComponentId('tpMj7ws');
    $componentTag = $_instance->getRenderedChildComponentTagName('tpMj7ws');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tpMj7ws');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('tpMj7ws', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('NH35reT')) {
    $componentId = $_instance->getRenderedChildComponentId('NH35reT');
    $componentTag = $_instance->getRenderedChildComponentTagName('NH35reT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NH35reT');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('NH35reT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/u101566037/domains/ibdl.net/public_html/blog/vendor/filament/filament/src/../resources/views/components/topbar.blade.php ENDPATH**/ ?>